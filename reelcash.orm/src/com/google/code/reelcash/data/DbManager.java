...
public class DbManager {
    ...
    private static String getResourceFileContents(String fileName) {
        try {
            InputStream stream = DbManager.class.getResourceAsStream(fileName);
    ...
    private static String getCreateDbString() {
        return getResourceFileContents("database.sql");
    }

    private static String getLoadInitialDataString() {
        return getResourceFileContents("initial_data.sql");
    }
    ...
    public static boolean checkCreateDb() throws SQLException {
        ...
        try {
            ...
            ret += createDb.executeUpdate(getCreateDbString());
            ret += createDb.executeUpdate(getLoadInitialDataString());
