...
insert into counties(region_id, code, name) values(1, 'SJ', 'Salaj');
...
insert into cities(county_id, "name") values(5, 'Cehu Silvaniei');
...
insert into locations(city_id, address, postal_code) values (5, 'nr. 75', '437361');
insert into locations(city_id, address, postal_code) values (2, 'B-dul Regina Elisabeta nr.5, Sector 3', '030016');
insert into locations(city_id, address, postal_code) values (6, 'Str. Trandafirilor nr.19', '455100');
...
insert into banks("name", location_id, allow_currency_exchange) values ('Banca Comerciala Romana', 8, 0);
insert into banks("name", location_id, parent_id, allow_currency_exchange) values ('BCR Cehu Silvaniei', 9, 4, 0);
...
insert into bank_accounts(bank_id, account) values(5, 'RO97RNCB0215025167360001');
...
insert into businesses(`name`, location_id, bank_account_id, legal_status_id) values('SC EXTRUPLAST SRL', 7, 3, 6);
...
insert into business_permissions(business_id, permission_id) values (3, 2);
...
insert into fiscal_identification(business_id, `name`, `value`) values (3, 'CIF', 'RO16948210');
insert into fiscal_identification(business_id, `name`, `value`) values (3, 'CUI', '16948210');
insert into fiscal_identification(business_id, `name`, `value`) values (3, 'ORC', 'J24/1730/2004');
