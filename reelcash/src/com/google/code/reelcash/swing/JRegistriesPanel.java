...
import com.google.code.reelcash.swing.registry.CurrenciesPanel;
...
import com.google.code.reelcash.swing.registry.ExciseTypesPanel;
import com.google.code.reelcash.swing.registry.FiscalIdentificationPanel;
import com.google.code.reelcash.swing.registry.GoodExcisesPanel;
import com.google.code.reelcash.swing.registry.GoodTaxesPanel;
import com.google.code.reelcash.swing.registry.GoodsPanel;
...
import com.google.code.reelcash.swing.registry.SeriesRangesPanel;
import com.google.code.reelcash.swing.registry.TaxTypesPanel;
import com.google.code.reelcash.swing.registry.UnitsPanel;
import com.google.code.reelcash.swing.registry.VatTypesPanel;
...
public class JRegistriesPanel extends JPanel {
    ...
    private void initializeNodePanelMappings() {
        ...
        nodePanelMappings.put(CurrencyNode.getInstance(), new CurrenciesPanel());
        ...
        nodePanelMappings.put(SeriesRangeNode.getInstance(), new SeriesRangesPanel());
        nodePanelMappings.put(VatTypeNode.getInstance(), new VatTypesPanel());
        nodePanelMappings.put(TaxTypeNode.getInstance(), new TaxTypesPanel());
        nodePanelMappings.put(ExciseTypeNode.getInstance(), new ExciseTypesPanel());
        nodePanelMappings.put(GoodNode.getInstance(), new GoodsPanel());
        nodePanelMappings.put(GoodTaxNode.getInstance(), new GoodTaxesPanel());
        nodePanelMappings.put(GoodExciseNode.getInstance(), new GoodExcisesPanel());
        nodePanelMappings.put(UnitNode.getInstance(), new UnitsPanel());
    }
