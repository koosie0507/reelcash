 ...
 *
 * Created on Apr 6, 2010, 5:13:00 PM
 */
...
public class NewMasterDetailForm extends JPanel {
  ...
  private void initComponents() {
    ...
    entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("jdbc:sqlite:D:\\Leisure\\sql\\reelcash.dbPU").createEntityManager();
    query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT o FROM Object o");
  ...
  private class FormListener implements java.awt.event.ActionListener {
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<java.lang.Object> merged = new ArrayList<java.lang.Object>(list.size());
